...
namespace Gold {
	...
	{
		m_DirectoryIcon = Texture2D::Create("Resources/Icons/ContentBrowser/DirectoryIcon.png", false, true);
		m_FileIcon = Texture2D::Create("Resources/Icons/ContentBrowser/FileIcon.png", false, true);
	}
